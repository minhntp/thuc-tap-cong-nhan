...
@section('content')
            ...
            <a href="{{ route('getSlide') }}"><button class="btn-info btn">Trở lại</button></a>
                <div class="xs">
                    ...
                    <form action="{{ route('postThemSlide') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="moTaNgan" class="form-control1" id="focusedinput" value="{{ old('moTaNgan') }}" placeholder="AirMax...">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Mô tả dài</label>
                            <div class="col-sm-8">
                                <input type="text" name="moTaDai" class="form-control1" id="focusedinput" value="{{ old('moTaDai') }}" placeholder="My Life...">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Link</label>
                            <div class="col-sm-8">
                                <input type="text" name="link" class="form-control1" id="focusedinput" value="{{ old('link') }}" placeholder="URL here">
                            </div>
                        </div>
